...
<h1 class="article-title text-center background-success" style="margin:0 0 30px 0;padding: .80rem 0; ">Add your
    book</h1>
<div class="container" style="display:flex;height: min-content">
    <form action="../bookcontroller/create" method="POST" enctype="multipart/form-data" class="row"
          style="display:table-row;padding:10px 20px;flex: 1;">
        <!-- Error Warning -->
        ...
        <div class="row" style="display:flex;padding:10px 20px;flex: 1;">
            <div class="row">
                ...
                <div class="form-group text-center sm-6" style="display: flex;justify-content: center;align-items: center;flex-direction: column">
                    <label for="bk_mainImgUrl"><b>Book Image</b></label>
                    <!-- Kitap Placeholder'ı -->
                    <img style="width: 150px;height: 150px;" src="https://coldtimemuhendislik.com/wp-content/uploads/2020/06/default-placeholder.png"
                         onclick="triggerClick()" id="imageDisplay">
                    <input type="file" name="bk_mainImgUrl" onchange="displayImage(this)" id="bk_mainImgUrl"
                           style="display: none">
                </div>
            </div>
