...
<h1 class="article-title text-center background-success" style="margin:0 0 30px 0;padding: .80rem 0; ">Profile Update</h1>
<div class="container" style="display:flex;height: min-content">
    <form action="../user/update_user/<?=$user['usr_id']?>" method="POST" enctype="multipart/form-data" class="row" style="display:table-row;padding:10px 20px;flex: 1;">
        <!-- Error Warning -->
